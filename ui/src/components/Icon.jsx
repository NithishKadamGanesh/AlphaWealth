...
// SVG icon library — no emojis anywhere in the app

export const Icon = ({ name, size = 16, stroke = 2, color = "currentColor" }) => {
  const p = {
  ...
  const I = {
    ...
    trending:  <svg {...p}><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>,
    ...
    bank:      <svg {...p}><line x1="3" y1="21" x2="21" y2="21"/><line x1="3" y1="10" x2="21" y2="10"/><polyline points="5 6 12 3 19 6"/><line x1="4" y1="10" x2="4" y2="21"/><line x1="20" y1="10" x2="20" y2="21"/><line x1="8" y1="14" x2="8" y2="17"/><line x1="12" y1="14" x2="12" y2="17"/><line x1="16" y1="14" x2="16" y2="17"/></svg>,
    sparkle:   <svg {...p}><path d="M12 3l1.5 5L19 9l-5.5 1L12 15l-1.5-5L5 9l5.5-1z"/></svg>,
    ...
    arrow_up:  <svg {...p}><line x1="7" y1="17" x2="17" y2="7"/><polyline points="7 7 17 7 17 17"/></svg>,
    arrow_dn:  <svg {...p}><line x1="17" y1="7" x2="7" y2="17"/><polyline points="17 17 7 17 7 7"/></svg>,
    ...
    chevron_r: <svg {...p}><polyline points="9 18 15 12 9 6"/></svg>,
    ...
    car:       <svg {...p}><path d="M14 16H9m10 0h3v-3.15a1 1 0 0 0-.84-.99L16 11l-2.7-3.6a1 1 0 0 0-.8-.4H5.24a2 2 0 0 0-1.8 1.1l-.8 1.63A6 6 0 0 0 2 12.42V16h2"/><circle cx="6.5" cy="16.5" r="2.5"/><circle cx="16.5" cy="16.5" r="2.5"/></svg>,
    ...
    film:      <svg {...p}><rect x="2" y="2" width="20" height="20" rx="2.18"/><line x1="7" y1="2" x2="7" y2="22"/><line x1="17" y1="2" x2="17" y2="22"/><line x1="2" y1="12" x2="22" y2="12"/></svg>,
    burger:    <svg {...p}><path d="M2 11h20"/><path d="M2 16h20"/><path d="M22 11a8 8 0 1 0-20 0"/></svg>,
    plug:      <svg {...p}><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>,
    ...
    diamond:   <svg {...p}><path d="M2.7 10.3a2.41 2.41 0 0 0 0 3.41l7.59 7.59a2.41 2.41 0 0 0 3.41 0l7.59-7.59a2.41 2.41 0 0 0 0-3.41L13.7 2.71a2.41 2.41 0 0 0-3.41 0z"/></svg>,
    medical:   <svg {...p}><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>,
    // ─── New analytics icons ─────────────────────────────────
    ...
    beaker:    <svg {...p}><path d="M9 3h6m-5 0v6L4 19a2 2 0 0 0 1.7 3h12.6A2 2 0 0 0 20 19l-6-10V3"/><line x1="6" y1="14" x2="18" y2="14"/></svg>,
    puzzle:    <svg {...p}><path d="M19.439 7.85c-.049.322.059.648.289.878l1.568 1.568c.47.47.706 1.087.706 1.704s-.235 1.233-.706 1.704l-1.611 1.611a.98.98 0 01-.837.276c-.47-.07-.802-.48-.879-.95a1.5 1.5 0 00-2.876-.46c-.21.485-.184.92-.184.92h-3.99V12.74a1.5 1.5 0 011.5-1.5h.79c.46.07.94-.27 1-.74a1.5 1.5 0 00-2.88-.66c-.18.49-.18.91-.18.91H6.99V8.74c0-.55.45-1 1-1h.83c.32-.05.64-.27.78-.57a1.5 1.5 0 11-2.71-1.34c.13-.32.42-.55.74-.61.4-.06.79.06 1.05.31.49.49 1.27.49 1.76 0 .25-.27.36-.66.31-1.06s-.27-.66-.6-.79c-.62-.14-.93.46-1.31.55a1.5 1.5 0 11-1.39-2.4c.49.05 1.03.55 1.42.79.49.49 1.27.49 1.76 0 .27-.27.42-.65.42-1.04 0-.83-.67-1.5-1.5-1.5"/></svg>,
    scale:     <svg {...p}><line x1="12" y1="3" x2="12" y2="21"/><path d="M5 8l-3 8h6z"/><path d="M19 8l3 8h-6z"/><path d="M5 8h14"/><line x1="9" y1="21" x2="15" y2="21"/></svg>,
  };
  return I[name] || null;
};
